...
<img src="https://github.com/Sandy-exe/curved_labeled_gradient_navigation_bar/blob/Final/gradient.png?raw=true" alt="gradient" width="200" align="left" />
...
```yaml
dependencies:
  curved_labeled_navigation_bar: ^2.0.13 #latest version
```
